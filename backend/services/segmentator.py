...
def run_segmentation_pipeline(series_uid: str, task: str = "total", fast: bool = True) -> dict:
    ...
    try:
        ...
        try:
            ...
            task_display = task_name.replace("_", " ").title() if task_name != "total" else "Whole Body"
            ...
            print(f"[TotalSegmentator] Updated DICOM header: SeriesDescription='{ds.SeriesDescription}'")
